...
public class AccuracyTest_Range {
    ...
    public static String outFileF = System.getProperty("user.dir") + "/result/" + "newHSM_range_F.csv";
    ...
    public static void calAccuracy() throws IOException {
        ...
        Path path3 = Paths.get(result_pre_range_stgcn);
        Scanner scanner3 = new Scanner(path3);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>>> range_stgcn_map = new HashMap<>();
        while (scanner3.hasNextLine()) {
            ...
            range_stgcn_map.put(range, tra_map);
        }

        Path path4 = Paths.get(result_pre_range_tgcn);
        Scanner scanner4 = new Scanner(path4);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>>> range_tgcn_map = new HashMap<>();
        while (scanner4.hasNextLine()) {
            ...
            range_tgcn_map.put(range, tra_map);
        }

        Path path5 = Paths.get(result_pre_range_astgnn);
        Scanner scanner5 = new Scanner(path5);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>>> range_astgnn_map = new HashMap<>();
        while (scanner5.hasNextLine()) {
            ...
            range_astgnn_map.put(range, tra_map);
        }
        ...
        for (int range: ranges) {
            ...
            HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> tra_stgcn_map = range_stgcn_map.get(range);
            HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> tra_tgcn_map = range_tgcn_map.get(range);
            HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> tra_astgnn_map = range_astgnn_map.get(range);
