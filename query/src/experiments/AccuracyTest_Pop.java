...
//    static int populationThreshold = 2;
    ...
    public static String outFileF = System.getProperty("user.dir") + "/result/" + "newHSM_population_F.csv";
    ...
    public static void calAccuracy() throws IOException {
        String resultAcc = "population" + "\t" + "ge" + "\t" + "le" + "\t" + "stgcn" + "\t" + "tgcn" + "\t" + "astgnn" + "\n";
        String resultRecall = "population" + "\t" + "ge" + "\t" + "le" + "\t" + "stgcn" + "\t" + "tgcn" + "\t" + "astgnn" + "\n";
        String resultF = "population" + "\t" + "ge" + "\t" + "le" + "\t" + "stgcn" + "\t" + "tgcn" + "\t" + "astgnn" + "\n";
        ...
        Path path3 = Paths.get(result_pre_population_stgcn);
        Scanner scanner3 = new Scanner(path3);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>>> population_stgcn_map = new HashMap<>();
        while (scanner3.hasNextLine()) {
            ...
            population_stgcn_map.put(population, tra_map);
        }

        Path path4 = Paths.get(result_pre_population_tgcn);
        Scanner scanner4 = new Scanner(path4);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>>> population_tgcn_map = new HashMap<>();
        while (scanner4.hasNextLine()) {
            ...
            population_tgcn_map.put(population, tra_map);
        }

        Path path5 = Paths.get(result_pre_population_astgnn);
        Scanner scanner5 = new Scanner(path5);

        HashMap<Integer, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>>> population_astgnn_map = new HashMap<>();
        while (scanner5.hasNextLine()) {
            ...
            population_astgnn_map.put(population, tra_map);
        }
        ...
        for (int populationThreshold: populations) {
            ...
            HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> tra_stgcn_map = population_stgcn_map.get(populationThreshold);
            HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> tra_tgcn_map = population_tgcn_map.get(populationThreshold);
            HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> tra_astgnn_map = population_astgnn_map.get(populationThreshold);
