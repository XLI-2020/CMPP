...
public class Experiment_SafeDuration {
    ...
    public static void run(String outFileTime, String outFileMemory, String outFileNum) throws IOException {
        String resultTime = "safeDuration" + "\t" + "ge" + "\t" + "le" + "\t" + "stgcn" + "\t" + "tgcn" + "\t" + "astgnn" + "\n";
        String resultMemo = "safeDuration" + "\t" + "ge" + "\t" + "le" + "\t" + "stgcn" + "\t" + "tgcn" + "\t" + "astgnn" + "\n";
...
//            arrNumAll.add(arrNum1);
        ...
        try {
            FileWriter output = new FileWriter(result_pre_safeDuration_stgcn);
            output.write(s3);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_safeDuration_tgcn);
            output.write(s4);
            output.flush();
            output.close();
        } catch (IOException e) {
        ...
        try {
            FileWriter output = new FileWriter(result_pre_safeDuration_astgnn);
            output.write(s5);
            output.flush();
            output.close();
        } catch (IOException e) {
