...
from utils.model_component import SaGcnGru,integrated_loss,eval_kl, eval_dist
import argparse
...
model = SaGcnGru(norm_adj,in_channels,out_channels,hidden_size,output_size).to(device=args.device)
